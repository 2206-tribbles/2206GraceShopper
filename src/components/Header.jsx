...
const Header = (props) => {
    ...
    return (
        <header id="header">
            <div className="titleBar"><NavLink to="/" className="link"><div id="title">
                <div className="capital">G</div>raceland <div className="capital">S</div>hopper</div></NavLink>
                {token ? <div className="loggedInAs"> 
                    <div>Logged in as {localStorage.getItem("username")}</div>
                    <div>My stuff</div>
                </div>: <div className="loggedInAs">Browsing as Guest</div>}
            ...
            <div id="controls">
                ...
                <div id="userlinks">
                    ...
                    {token ? <span className="link" onClick={handleLogout}>Logout</span> : <NavLink to="/Login" className="link">Login/Register</NavLink>}
                    {userId === "6" ? (
